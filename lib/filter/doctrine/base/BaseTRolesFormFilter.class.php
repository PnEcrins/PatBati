...
class BaseTRolesFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'pne'           => new sfWidgetFormFilterInput(),
      'assermentes'   => new sfWidgetFormFilterInput(),
      'enposte'       => new sfWidgetFormFilterInput(),
      'dernieracces'  => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate(), 'with_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'pne'           => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'assermentes'   => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'enposte'       => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'dernieracces'  => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDate(array('required' => false)), 'to_date' => new sfValidatorDate(array('required' => false)))),
