...
class BaseIdentificationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'l2x'                         => new sfWidgetFormFilterInput(),
      'l2y'                         => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'l2x'                         => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'l2y'                         => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
