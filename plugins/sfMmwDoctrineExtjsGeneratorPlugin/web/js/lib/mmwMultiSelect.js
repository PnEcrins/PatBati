 ...
 */
Ext.ux.mmwMultiselect = Ext.extend(Ext.form.Field,  {
    /**
    ...
    initComponent: function(){
        ...
        if(Ext.isArray(this.store)){
            if (Ext.isArray(this.store[0])){
                ...
                this.store = new Ext.data.ArrayStore({
                    //fields: ['text'], modified by nwezel
                    fields: ['value','text'],
                    data: this.store,
                    expandData: true
                });
    ...
    onRender: function(ct, position){
        Ext.ux.mmwMultiselect.superclass.onRender.call(this, ct, position);
    ...
    afterRender: function(){
        Ext.ux.mmwMultiselect.superclass.afterRender.call(this);
        ...
        if (this.draggable || this.dragGroup){
            this.dragZone = new Ext.ux.mmwMultiselect.DragZone(this, {
                ddGroup: this.dragGroup
            });
        }
        if (this.droppable || this.dropGroup){
            this.dropZone = new Ext.ux.mmwMultiselect.DropZone(this, {
    ...
    destroy: function(){
        ...
        Ext.ux.mmwMultiselector.superclass.destroy.call(this);
    }
});

Ext.reg("multiselect", Ext.ux.mmwMultiselect);

Ext.ux.mmwMultiselect.DragZone = function(ms, config){
    this.ms = ms;
    this.view = ms.view;
    ...
    Ext.ux.mmwMultiselect.DragZone.superclass.constructor.call(this, this.ms.fs.body, { containerScroll: true, ddGroup: dd });
    this.setDraggable(ddGroup);
};

Ext.extend(Ext.ux.mmwMultiselect.DragZone, Ext.dd.DragZone, {
    // private
...
Ext.ux.mmwMultiselect.DropZone = function(ms, config){
    this.ms = ms;
    this.view = ms.view;
    var ddGroup = config.ddGroup || 'MultiselectDD';
    var dd;
    ...
    Ext.ux.mmwMultiselect.DropZone.superclass.constructor.call(this, this.ms.fs.body, { containerScroll: true, ddGroup: dd });
    this.setDroppable(ddGroup);
};

Ext.extend(Ext.ux.mmwMultiselect.DropZone, Ext.dd.DropZone, {
    /**
