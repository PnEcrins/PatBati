            ...
            if (o = this.getConnectionObject(uri, options, postData)) {
                ...
                try {
                    ...
                    if(callback && callback.timeout){
                        //FIX : r.timeout causait une erreur lorsque la requête ajax était synchrone ( options.async = false )
                        //('timeout' in r) && (r.timeout = callback.timeout);
                        if('timeout' in r && options.async !== false) {
                          r.timeout = callback.timeout;
                        }
