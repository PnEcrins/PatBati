 ...
 */
class Base<?php echo ucfirst($this->getModuleName()) ?>GeneratorConfiguration extends sfMmwExtjsModelGeneratorConfiguration
{
...
<?php unset($this->config['list']['table_count_method']) ?>
  ...
  public function getDisplayField() 
	{
		return '<?php echo isset($this->config['list']['display_field']) ? $this->config['list']['display_field'] : '' ?>';
	}
<?php unset($this->config['list']) ?>
